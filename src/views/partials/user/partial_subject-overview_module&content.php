...
<div class="w-100 px-2 pb-4">
    ...
    <ul class="nav nav-underline" id="contentTabs" role="tablist">
        ...
        <?php if ($totalSubmissionAttemps > 0 && userHasPerms(['Student'])): ?>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="submission-tab" data-bs-toggle="tab" data-bs-target="#submission" type="button" role="tab" aria-controls="submission" aria-selected="false">
                    Submission
                </button>
            </li>
        <?php endif; ?>
