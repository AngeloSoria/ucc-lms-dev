    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                ...
                <form id="programForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 d-flex gap-2">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="program_code" name="program_code" placeholder="Enter Course Code" required>
                        </div>

                        <div class="flex-grow-1">
                            <label for="program_name" class="form-label">Program Name</label>
                            <input type="text" class="form-control" id="program_name" name="program_name" placeholder="Enter Course Name" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Add Description here" id="program_description" name="program_description" style="height: 150px"></textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary c-primary" form="programForm">Add</button>
            </div>
        </div>
    </div>
</div>