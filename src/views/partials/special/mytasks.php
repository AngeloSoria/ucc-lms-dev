<div class="d-flex justify-content-end bg-transparent w-100">
    <div class="bg-white p-3 shadow-sm rounded w-100 border" id="myCalendar">
        ...
        <div>
            ...
            <a href="#" class="text-decoration-none text-dark d-block w-100 text-center fs-6 opacity-50">View All Tasks</a>
        </div>
    </div>
</div>