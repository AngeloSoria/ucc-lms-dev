    ...
    <div class="tab-content" id="myTabContent">
        <div class="" id="information">
            <div class="position-relative p-3">
                <div class="card-body">
                    <div class="mb-5">
                        <h5 class="fs-5 text-center"><?php echo $enrolledSubjectInformation['data']['subject_name']; ?>
                        </h5>
                        <p class="fs-6 text-center">Enrollment Overview</p>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12 gap-2 d-flex justify-content-end align-items-center">
                            <span class="btn btn-success" role="button" data-bs-toggle="modal"
                                data-bs-target="#enrollRegularStudentModal">
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="dataTable_enrolledSubjects"
                                class="table table-responsive table-hover border table-bordered" style="width: 100%">
                                ...
                                <thead class="table-brand-secondary">
                                    <tr>
                                        <th class="text-center" style="width: 5%;"><input type="checkbox"
                                                id="checkbox_selectAll" class="form-check-input" accesskey=""
                                                value="<?php echo $_GET['viewSection'] ?>"></th>
                                    ...
                                    <?php } else { ?>
                                        <?php foreach ($enrolledStudentsFromSubjectSection['data'] as $enrolledStudentInfo) {
                                            ...
                                            <tr class="table-default">
                                                <td class="text-center text-truncate"><input type="checkbox" title="selectAll"
                                                        class="form-check-input"></td>
                                                <td class="align-center text-center">
                                                    <a title="View Subject" class="badge badge-secondary"
                                                        href="<?php echo "users_admin.php?viewRole=Student&user_id=" . $enrolledStudentInfo['user_id'] ?>">
                                                        <?php echo $enrolledStudentInfo['user_id'] ?>
                                                    </a>
                                                </td>
                                                <td class="" contenteditable="true">
                                                    <?php echo $enrolledStudentInfo['first_name'] . " " . $enrolledStudentInfo['middle_name'] . " " . $enrolledStudentInfo['last_name'] ?>
                                                </td>
...
<div class="modal fade" id="enrollRegularStudentModal" tabindex="-1" aria-labelledby="enrollRegularStudentModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title ctxt-primary" id="enrollRegularStudentModalLabel">Enroll
                    Students<?php echo ' | ' . $enrolledProgramToSection['data'][0]['educational_level'] ?></h5>
            ...
            <form id="enrollRegularStudentModalForm" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <input type="hidden" id="inp_educational_level" name="educational_level"
                        value="<?php echo $enrolledProgramToSection['data'][0]['educational_level'] ?>">
                    <input type="hidden" id="section_id" name="section_id" value="<?php echo $_GET['viewSection'] ?>">
                    <input type="hidden" id="subject_section_id" name="subject_section_id"
                        value="<?php echo $enrolledProgramToSection['data'][0]['educational_level'] ?>">
                    <div class="mb-3 d-flex gap-2">
                        <div class="col-md-12 d-flex flex-column">
                            <label for="input_enrollStudents" class="form-label">Students</label>
                            <select class="form-select d-flex flex-wrap" id="input_enrollStudents"
                                name="input_enrollStudents[]" multiple></select>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary c-primary"
                        form="enrollRegularStudentModalForm">Save</button>
                </div>
            </form>
        </div>
    </div>
